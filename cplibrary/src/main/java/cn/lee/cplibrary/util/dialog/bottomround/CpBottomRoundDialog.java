...
public class CpBottomRoundDialog<T extends BaseDialogBean> {
    ...
    public Dialog showDialog(final DialogCertificateCallBack callback) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.cp_dialog_bottom_round_list, null);
        setView(view);
        final Dialog dialog = CpComDialog.getBottomDialog(context, true, view);
        RecyclerView recyclerView = view.findViewById(R.id.recyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false));
        BottomRoundDialogAdapter adapter = new BottomRoundDialogAdapter(context, list, this);
        recyclerView.setAdapter(adapter);
        adapter.setOnItemClickListener(new BottomRoundDialogAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(BottomRoundDialogAdapter adapter, View rootView, int position) {
                dialog.dismiss();
...
//        //取消按钮设置
    ...
    public interface DialogCertificateCallBack {
        void sure(BottomRoundDialogAdapter adapter, View rootView, int position);
    ...
    public static class Builder<K extends BaseDialogBean> {
        ...
        public CpBottomRoundDialog build() {
            CpBottomRoundDialog dialog = new CpBottomRoundDialog(context);
            dialog.setList(list);
