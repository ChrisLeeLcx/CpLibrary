...
/**
 * @author zouyuanfeng
 * 组内元素具有单选功能的 FlexboxLayout，其子控件是RadioButton
 * @version 16-10-20 11:34
 * 使用方式：布局中引用添加属性    app:flexWrap="wrap"
 * java文件中使用：属性clearCheck(); 清空所有选择
 * 具体使用案例见PopupWindowUtil，和新能源newenergy项目的SelectCarActivity
 */
