...
public class ShapeLoadingView extends View {
    ...
    private void init() {
        mPaint = new Paint();
        mPaint.setColor(getResources().getColor(R.color.cp_triangle));
        mPaint.setAntiAlias(true);
        mPaint.setStyle(Paint.Style.FILL_AND_STROKE);
        setBackgroundColor(getResources().getColor(R.color.cp_view_bg));
          mTriangleColor = getResources().getColor(R.color.cp_triangle);
          mCircleColor = getResources().getColor(R.color.cp_circle);
          mRectColor = getResources().getColor(R.color.cp_triangle);
    }
        ...
        switch (mShape) {
            ...
            case SHAPE_CIRCLE:
                ...
                if (mIsLoading) {
                    ...
                    mPaint.setColor(getResources().getColor(R.color.cp_circle));
                    Path path = new Path();
            ...
            case SHAPE_RECT:
                ...
                if (mIsLoading) {
                    ...
                    mPaint.setColor(getResources().getColor(R.color.cp_rect));
