...
/**
 * function:供ScrollTopPoiGridLayoutManager 和ScrollTopPoiLinearLayoutManager使用
 */

class TopPoiLinearSmoothScroller extends LinearSmoothScroller {

    public TopPoiLinearSmoothScroller(Context context) {
        super(context);
    }
