...
public class LoadingView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context
                .obtainStyledAttributes(attrs, R.styleable.cp_LoadingView);
        mLoadText = typedArray.getString(R.styleable.cp_LoadingView_cp_loadingTxt);
        mTextAppearance = typedArray.getResourceId(R.styleable.cp_LoadingView_cp_loadingTextAppearance, -1);
    ...
    protected void onFinishInflate() {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.cp_load_view, null);
