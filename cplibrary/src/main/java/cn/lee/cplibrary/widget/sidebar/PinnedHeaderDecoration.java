...
public class PinnedHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    /**
     * @param hasHeader:依附的RecyclerView 是否有头部，因为头部View不需要悬停view的展示
     */
    public PinnedHeaderDecoration(boolean hasHeader) {
...
//            c.clipRect(mClipBounds, Region.Op.UNION);
    ...
    private void createPinnedHeader(RecyclerView parent) {
        ...
        if (hasHeader && firstVisiblePosition == 0) {
    ...
    public interface PinnedHeaderCreator {
        /**
         * @param adapterPosition: RecyclerView悬停的字母在列表中的位置，若RecyclerView有头部局，adapterPosition从1开始，否则从0开始
         */
