package cn.lee.cplibrary.widget.viewpager.lazy;
...
public class LazyViewPager extends ViewPager {
	...
	public LazyViewPager(Context context, AttributeSet attrs) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.cp_LazyViewPager);
		setInitLazyItemOffset(a.getFloat(R.styleable.cp_LazyViewPager_cp_init_lazy_item_offset, DEFAULT_OFFSET));
		a.recycle();
	}
