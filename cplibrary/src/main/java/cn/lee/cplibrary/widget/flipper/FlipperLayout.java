...
public class FlipperLayout extends ViewGroup {
    ...
    /***
     * @param listener
     * @param currentBottomView 最底层的view，初始状态看不到（下一页）
     * @param currentShowView   正在显示的View（当前页）
     * @param currentTopView    最上层的View，初始化时滑出屏幕（上一页）
     */
    ...
    public void computeScroll() {
        ...
        if (mScroller.computeScrollOffset()) {
            ...
            if (mTouchResult == MOVE_TO_LEFT) { //下一页
                ...
                if (mListener != null && mListener.currentIsNotLastPage()) { //当前页不是最后一页
