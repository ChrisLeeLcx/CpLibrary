...
public class SwipeBackLayout extends FrameLayout {
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.cp_SwipeBackLayoutStyle);
    }
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.cp_SwipeBackLayout, defStyle,
                R.style.cp_SwipeBackLayout);

        int edgeSize = a.getDimensionPixelSize(R.styleable.cp_SwipeBackLayout_cp_edge_size, -1);
        if (edgeSize > 0) {
            setEdgeSize(edgeSize);
        }
        int mode = EDGE_FLAGS[a.getInt(R.styleable.cp_SwipeBackLayout_cp_edge_flag, 0)];
        setEdgeTrackingEnabled(mode);

        int shadowLeft = a.getResourceId(R.styleable.cp_SwipeBackLayout_cp_shadow_left,
                R.drawable.shadow_left);
        int shadowRight = a.getResourceId(R.styleable.cp_SwipeBackLayout_cp_shadow_right,
                R.drawable.shadow_right);
        int shadowBottom = a.getResourceId(R.styleable.cp_SwipeBackLayout_cp_shadow_bottom,
