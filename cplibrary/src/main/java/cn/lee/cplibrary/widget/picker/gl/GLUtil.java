...
public class GLUtil {
    public static final String UNKNOWN_HOUR_LABEL = "未知";//未知时辰的表示
...
//    public static final String[] lunarMonths = {"正月","二","三","四","五","六","七","八","九","十","十一","十二"};

    public static final String[] lunarDays = {	"初一","初二","初三","初四","初五","初六","初七","初八","初九","初十",
                                                "十一","十二","十三","十四","十五","十六","十七","十八","十九","廿十",
                                                "廿一","廿二","廿三","廿四","廿五","廿六","廿七","廿八","廿九","三十"};

//    public static final String[] lunarHours = {"0子时","1丑时","2丑时","3寅时","4寅时","5卯时","6卯时","7辰时","8辰时",
//            "9巳时","10巳时","11午时","12午时","13未时","14未时","15申时","16申时","17酉时","18酉时",
//            "19戌时","20戌时","21亥时","22亥时","23子时"};
    public static final String[] lunarHours = {	UNKNOWN_HOUR_LABEL,"0子时","1丑时","2丑时","3寅时","4寅时","5卯时","6卯时","7辰时","8辰时",
            "9巳时","10巳时","11午时","12午时","13未时","14未时","15申时","16申时","17酉时","18酉时",
            "19戌时","20戌时","21亥时","22亥时","23子时"};
     ...
     * 获取农历的时辰的中文
     * @param hour
     * 			hour in number format, e.g. 1  ，0
     * 			hour should be in range of [0, 23]
     * @return
     * 			hour in Hanzi format, e.g. 0丑时
     */
//    public static String getLunarNameOfHour(int hour){
//        if(hour > -1 && hour < 24){
//            return lunarHours[hour];
//        }else{
//            throw new IllegalArgumentException("hour should be in range of [0, 23] hour is " + hour+"-1表示未知");
//        }
//    }
    /**
     * 获取农历的时辰的中文
     * @param hour
     * 			hour in number format, e.g. 1  ，-1
     * 			hour should be in range of [-1, 23]
     * @return
     * 			hour in Hanzi format, e.g. 0丑时 ,未知
     */
    public static String getLunarNameOfHour(int hour){
        if(hour > -2 && hour < 24){
            return lunarHours[hour + 1];
        }else{
            throw new IllegalArgumentException("hour should be in range of [0, 23] hour is " + hour+"-1表示未知");
        }
    }
