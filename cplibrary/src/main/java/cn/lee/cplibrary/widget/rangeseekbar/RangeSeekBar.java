...
import static cn.lee.cplibrary.widget.rangeseekbar.SeekBar.INDICATOR_MODE_ALWAYS_SHOW;
...
//    private float maxPositiveValue, minPositiveValue;
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        seekBarMode = t.getInt(R.styleable.cp_RangeSeekBar_cp_rsb_mode, SEEKBAR_MODE_RANGE);
        minProgress = t.getFloat(R.styleable.cp_RangeSeekBar_cp_rsb_min, 0);
        maxProgress = t.getFloat(R.styleable.cp_RangeSeekBar_cp_rsb_max, 100);
        rangeInterval = t.getFloat(R.styleable.cp_RangeSeekBar_cp_rsb_range_interval, 0);
        progressColor = t.getColor(R.styleable.cp_RangeSeekBar_cp_rsb_progress_color, 0xFF4BD962);
        progressRadius = (int) t.getDimension(R.styleable.cp_RangeSeekBar_cp_rsb_progress_radius, -1);
        progressDefaultColor = t.getColor(R.styleable.cp_RangeSeekBar_cp_rsb_progress_default_color, 0xFFD7D7D7);
        progressHeight = (int) t.getDimension(R.styleable.cp_RangeSeekBar_cp_rsb_progress_height, Utils.dp2px(getContext(),2));
        tickMarkMode = t.getInt(R.styleable.cp_RangeSeekBar_cp_rsb_tick_mark_mode, TRICK_MARK_MODE_NUMBER);
        tickMarkGravity = t.getInt(R.styleable.cp_RangeSeekBar_cp_rsb_tick_mark_gravity, TRICK_MARK_GRAVITY_CENTER);
        tickMarkNumber = t.getInt(R.styleable.cp_RangeSeekBar_cp_rsb_tick_mark_number, 1);
        tickMarkTextArray = t.getTextArray(R.styleable.cp_RangeSeekBar_cp_rsb_tick_mark_text_array);
        tickMarkTextMargin = (int) t.getDimension(R.styleable.cp_RangeSeekBar_cp_rsb_tick_mark_text_margin, Utils.dp2px(getContext(),7));
        tickMarkTextSize = (int) t.getDimension(R.styleable.cp_RangeSeekBar_cp_rsb_tick_mark_text_size, Utils.dp2px(getContext(),12));
        tickMarkTextColor = t.getColor(R.styleable.cp_RangeSeekBar_cp_rsb_tick_mark_text_color, progressDefaultColor);
        tickMarkInRangeTextColor = t.getColor(R.styleable.cp_RangeSeekBar_cp_rsb_tick_mark_text_color, progressColor);
        t.recycle();
    }
