    ...
    public MaterialRatingDrawable(Context context, boolean fillBackgroundStars) {
        super(new Drawable[] {
                createLayerDrawableWithTintAttrRes(fillBackgroundStars ?
                        R.drawable.cp_mrb_star_icon_black_36dp
                        : R.drawable.cp_mrb_star_border_icon_black_36dp, fillBackgroundStars ?
                ...
                fillBackgroundStars ? createClippedLayerDrawableWithTintColor(
                        R.drawable.cp_mrb_star_icon_black_36dp, Color.TRANSPARENT, context)
                        : createClippedLayerDrawableWithTintAttrRes(
                        R.drawable.cp_mrb_star_border_icon_black_36dp, R.attr.colorControlActivated,
                        context),
                createClippedLayerDrawableWithTintAttrRes(R.drawable.cp_mrb_star_icon_black_36dp,
